...
export function AuthPanel({ onClose, onSignedIn }: Props) {
  ...
  async function handleGoogle() {
    ...
    setBusy(true);
    try {
      // Tarayıcıyı Google'a yönlendirir; başarılı olursa bu fonksiyon hiç
      // dönmez (sayfa navigasyonu). Yalnızca yönlendirme BAŞLAMADAN önce
      // bir hata olursa (ör. sağlayıcı Supabase'de kapalıysa) buraya döner.
          ...
          <form className="form" onSubmit={handleSubmit}>
            ...
            {mode !== 'reset' && (
              <>
                <button
                  type="button"
                  className="button button--block button--google"
                ...
                <div className="form__divider" data-testid="auth-divider">
